...
class SelectTest extends React.Component {
	  ...
	  onChange(e) {
		var adrpr ="http://localhost:8080/api/paintings/search/findByArtistLike?name=";
	    this.setState({
	      value: adrpr + e.target.value
	    })
	  }
	  render() {
	    return (
	      <div className="form-group">
	        ...
	        <select value={this.state.value} onChange={this.onChange.bind(this)} className="form-control">
	          ...
	          <option value="Allaert%20van%20Everdingen">Allaert</option>
	          <option value="David%20Kl%C3%B6cker%20Ehrenstrahl">Daiv</option>
	          <option value="Nicolas%20Lancret">Niclas</option>
	        </select>
	        {this.state.value}
	      </div>
	    )
